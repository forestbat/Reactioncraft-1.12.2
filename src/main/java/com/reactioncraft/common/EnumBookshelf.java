...
{
    EMPTY(0, 11,   "one1",       "one1"),
    WEBBED_EMPTY(1, 10,   "one2",       "one2"),
    WEBBED_FULL(2, 9,   "one3",       "one3"),
    SCROLLCASE_EMPTY(3, 8,   "two1",       "two1"),
    ONE_THIRD(4, 7,   "two2", 	   "two2"),
    TWO_THIRDS(5, 6,   "two3",       "two3"),
    FULL(6, 5,   "three1",     "three1"),
    SCROLLCASE_ONE_THIRD(7, 4,   "three2",     "three2"),
    SCROLLCASE_TWO_THIRDS(8, 3,   "three3",     "three3"),
    SCROLLCASE_FULL(9, 2, 	 "four1",      "four1"),
    SCROLLCASE_WEBBED_EMPTY(10, 1, "four2",      "four2"),
    SCROLLCASE_WEBBED_FULL(11, 0, "four3",      "four3"),
