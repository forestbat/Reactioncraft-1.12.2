...
public class ItemIndex
{
    ...
    public static ItemFoodBase rawcorn;
    ...
    public static ItemCompleteNet creative_net;
    ...
    public static ItemBase ironShavings;
    ...
    public static ItemCurrencyArmor kinglyChest;
    public static ItemCurrencyArmor kinglyLegs;
    public static ItemCurrencyArmor kinglyBoots;
    public static ItemExtraCrowns emeraldcrown;
    public static ItemExtraCrowns diamondcrown;
    ...
    public static ItemBloodStoneArmor bloodstoneboots;
