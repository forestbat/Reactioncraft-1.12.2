...
public class ModelHydrolisc extends ModelBase
{
    ...
    public ModelHydrolisc(float tailWiggleSpeed)
    {
        this.animationSpeed = tailWiggleSpeed;
    ...
    public void render(Entity entity, float f, float f1, float f2, float f3, float f4, float f5)
    {
        ...
        if ((double)f1 > 0.1D)
        {
            newangle = MathHelper.cos(f2 * 1.3F * this.animationSpeed) * (float)Math.PI * 0.25F * f1;
        }
        else
        {
            newangle = 0.0F;
        ...
        newangle = MathHelper.cos(f2 * 1.0F * this.animationSpeed) * (float)Math.PI * 0.15F;
        ...
        newangle = MathHelper.cos(f2 * 1.25F * this.animationSpeed * hf) * (float)Math.PI * 0.2F * hf;
        this.feather2.rotateAngleY = newangle;
        newangle = MathHelper.cos(f2 * 0.75F * this.animationSpeed * hf) * (float)Math.PI * 0.2F * hf;
